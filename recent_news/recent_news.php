...
<div class="wrapper">
      <ul>
	  <li>
	  <a href="main.php"></a><a href="main.php">HOME</a>
	  </li>
	  <li><a href="#">RECENT NEWS</a></li>
	  <li>
	  <a href="main.php"></a><a href="login.php">PAYROLL SHEET</a>
	   </li>
	  <li>
	  <a href="main.php"></a><a href="contact.php">CONTACT</a>
	  </li>
	  </ul>  
	  <div id="clear"></div>
</div>
...
<div class="wrapper">
	   ...
	   <img src="image/icon2.png" onmouseover="this.src='image/icon3.png'" onmouseout="this.src='image/icon2.png'"/>
	   </div>
	   <div id="aboutcompany">
